const translations = {
  ...
  "virtual.machine.text":
    "*UDS Virtual Machine exceeds 20.1 GB.<br /> We recommend using Download Master to avoid breakdowns.",
  "free.of.charge": "Free of charge until December, 2021",
  "about.add.on": "About add-on",
  "how.to.install.and.uninstall": "How to install and uninstall",
  "dmt.text":
    "We designed UDS Data Migration Tool as an online solution with an intuitively comprehensive and convenient interface and functionality. Yet, for a better experience, we recommend the video tutorial first.",
  "installation.guide": " Installation guide",
  "for.faultless.user.experience":
    "for a faultless user experience. <br /> Download",
  hints: "hints",
