    ...
    return (
        <div className={'termsContainer'}>
            <section>
                ...
                <p>These terms and conditions outline the rules and regulations for the use of UDS Systems's Website.</p>
                ...
                <p>By accessing this website we assume you accept these terms and conditions in full.
                    Do not continue to use UDS Systems's website if you do not accept all of the terms
                ...
                <p>
                    ...
                    to the Client in the most appropriate manner, whether by formal meetings of a fixed duration,
                    or any other means, for the express purpose of meeting the Client's needs in respect of provision
                    of the Company's stated services/products, in accordance with and subject to, prevailing law of
                    Ukraine. Any use of the above terminology or other words in the singular, plural, capitalisation
                    and/or he/she or they, are taken as interchangeable and therefore as referring to same.
                </p>
            </section>
            <section>
                <h3>Cookies</h3>
                <p>We employ the use of cookies. By using UDS Systems's website you consent to the use of cookies
                    in accordance with UDS Systems's privacy policy.</p>
            ...
            <section>
                ...
                <p>Unless otherwise stated, UDS Systems and/or it's licensors own the intellectual property rights
                    for all material on UDS Systems. All intellectual property rights are reserved. You may view
                    and/or print pages from https://uds.systems/ for your own personal use subject to
                ...
                <ol>
                    ...
                    <li>Reproduce, duplicate or copy material from https://uds.systems/</li>
                </ol>
                <p>Redistribute content from UDS Systems (unless content is specifically made for redistribution).</p>
            </section>
            <section>
                ...
                <ol>
                    ...
                    <ol>
                        ...
                        <li>Online directory distributors when they list us in the directory
                            ...
                            the Web sites of other listed businesses;</li>
                    ...
                    <li>These organizations may link to our home page, to publications or to
                        other Web site information so long as the link: (a) is not in any way misleading;
                ...
                <p>We will approve link requests from these organizations if we determine that: (a)
                    ...
                    hyperlink outweighs the absence of !!!!! and (d) where the link is in the context
                    of general resource information or is otherwise consistent with editorial content in a newsletter
                ...
                <p>If you are among the organizations listed in paragraph 2 above and are interested
                    in linking to our website, you must notify us by sending an e-mail to info@uds.systems.
                    ...
                    intend to link to our Web site, and a list of the URL(s) on our site to which you would like to
                ...
                <p>No use of UDS Systems's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
            </section>
            <section>
                <h3>Iframes</h3>
            ...
            <section>
                ...
                <p>We reserve the right at any time and in its sole discretion to request that you remove all links
                    or any particular link to our Web site. You agree to immediately remove all links to our Web site
            ...
            <section>
                ...
                <p>The limitations and exclusions of liability set out in this Section and elsewhere in
                    ...
                    liabilities arising in contract, in tort (including negligence) and for breach of statutory duty.</p>
